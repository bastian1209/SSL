...
config.train.moclr_init_epoch = None
...
def get_config(method='moco'):
    ...
    if method == 'moco':
        ...
        config.model.ssl_feature_dim = 256
...
def match_config_with_args(config, args):
    ...
    if args.resume:
        ...
        config_path = os.path.dirname(args.resume) + '/experiment_config.yaml'
        ...
        config.train.moclr_init_epoch = args.moclr_init_epoch
